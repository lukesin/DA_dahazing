...
def define_G(input_nc, output_nc, ngf, which_model_netG, norm='batch', use_dropout=False, gpu_ids=[], use_parallel=True,
    ...
    if which_model_netG == 'resnet_9blocks':
        ...
        netG = ResnetGenerator_depth(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout,
                                     n_blocks=9, gpu_ids=gpu_ids, use_parallel=use_parallel,
                                     learn_residual=learn_residual)
    elif which_model_netG == 'resnet_new':
        netG = ResnetGenerator_new(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=3,
                                   gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual=learn_residual)
    elif which_model_netG == 'EDskipconn':
        netG = Encoder_Decoder(input_nc, output_nc, 8, ngf, norm_layer=norm_layer, use_dropout=use_dropout,
                               gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual=learn_residual)
    elif which_model_netG == 'resnet_new_double':
        netG = ResnetGenerator_new_double(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout,
                                          n_blocks=3, gpu_ids=gpu_ids, use_parallel=use_parallel,
                                          learn_residual=learn_residual)
    elif which_model_netG == 'resnet_16blocks_d3':
        netG = ResnetGenerator_down3(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout,
                                     n_blocks=16, gpu_ids=gpu_ids, use_parallel=use_parallel,
                                     learn_residual=learn_residual)
    elif which_model_netG == 'resnet_16blocks_di':
        netG = ResnetGenerator_dilated(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout,
                                       n_blocks=16, gpu_ids=gpu_ids, use_parallel=use_parallel,
                                       learn_residual=learn_residual)
        ...
        netG = ResnetGenerator(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=24,
                               gpu_ids=gpu_ids, use_parallel=use_parallel, learn_residual=learn_residual)
        ...
        netG = _UNetGenerator(input_nc, output_nc, ngf, layers=4, norm='batch', activation='PReLU', drop_rate=0,
                              add_noise=False, gpu_ids=gpu_ids, weight=0.1)
    else:
...
def define_patchD(input_nc, ndf=64, n_layers=3, num_D=1, norm='batch', activation='PReLU', init_type='xavier',
                  gpu_ids=[]):
...
class ResnetGenerator_new(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6,
        ...
        for i in range(n_blocks):
            model += [
                ResnetBlock_nonorm(ngf * mult, padding_type=padding_type, norm_layer=norm_layer,
                                   use_dropout=use_dropout,
                                   use_bias=use_bias)]
...
class ResnetGenerator_dilated(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6,
        ...
        mult = 2 ** n_downsampling
        for i in range(n_blocks):
            model += [ResnetBlock_dilated(ngf * mult, padding_type=padding_type, norm_layer=norm_layer,
...
class _ResGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, n_blocks=6, norm='batch', activation='PReLU', drop_rate=0,
    ...
    def __init__(self, outer_nc, inner_nc,
        ...
        if outermost:
            ...
            upconv = nn.ConvTranspose2d(inner_nc, outer_nc,
                                        ...
                                        padding=1, bias=use_bias)
            for i in range(6):
                resblocks += [ResnetBlock_nonorm(ngf * 4, padding_type=padding_type, norm_layer=norm_layer,
                                                 use_dropout=use_dropout,
                                                 use_bias=use_bias)]
            ...
            up = [upconv, uprelu]
            for i in range(3):
                resblocks += [ResnetBlock_nonorm(ngf * 2, padding_type=padding_type, norm_layer=norm_layer,
                                                 use_dropout=use_dropout,
                                                 use_bias=use_bias)]

...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--unlabel_decay', type=float, default=1.0,
                            help='decay the unlabel loss weights every epoch')
        ...
        parser.add_argument('--update_ratio', type=int, default=5,
                            help='the update ratio of the supervised and unsupervised')

...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--task_model_type', type=str, default='UNet',
                            help='select model for task network [UNet] |[ResNet]')
        parser.add_argument('--trans_model_type', type=str, default='ResNet',
                            help='select model for transform network [UNet] |[ResNet]')
        parser.add_argument('--transform_layers', type=int, default=9,
                            help='# of number of the down sample layers for transform network')
        parser.add_argument('--image_D_layers', type=int, default=3,
        ...
        parser.add_argument('--task_layers', type=int, default=4,
